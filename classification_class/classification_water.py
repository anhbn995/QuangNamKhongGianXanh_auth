...
from classification_class.ultils import get_img_coords, write_results, padded_for_org_img, \
...
def predict_water(image_path, weight_path, result_path, model, input_size_water, 
